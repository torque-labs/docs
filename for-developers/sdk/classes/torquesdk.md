...
| --------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| `_connection`   | `Connection`                                                                                            | The connection for the SDK instance         |
| `_signer`       | \| `undefined` \| `Adapter` \| `Keypair` \| [`PrivySolanaWallet`](../type-aliases/privysolanawallet.md) | The signer for the SDK instance             |
| `_transactions` | [`TorqueTransactionsModule`](torquetransactionsmodule.md)                                               | The tranactions module for the SDK instance |
| `apiUrl`        | `string`                                                                                                | The base URL of the Torque API              |
| `offers`        | [`TorqueOffersModule`](torqueoffersmodule.md)                                                           | The offers module for the SDK instance      |
| `user`          | `undefined` \| [`TorqueUserModule`](torqueusermodule.md)                                                | The user module for the SDK instance        |

...
| `options`             | { `apiUrl`: `string`; `authDomain`: `string`; `rpcUrl`: `string`; } | The Torque UI library options                     |
...
| `wallet?`             | `null` \| `Adapter` \| `PrivySolanaWallet`                          | The wallet to use for the Torque SDK              |

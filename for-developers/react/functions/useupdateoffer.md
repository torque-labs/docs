...
| Parameter           | Type                                                                                                                                                |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__namedParameters` | [`UseUpdateOfferOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/UseUpdateOfferOptions.md) |

### Returns

`UseMutationResult`<`OfferResponse`, `Error`, [`UpdateOfferParams`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/UpdateOfferParams.md), `unknown`>

...
| Parameter           | Type                                                                                                                                          |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `__namedParameters` | [`UseProjectsOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/UseProjectsOptions.md) |

...
| Parameter           | Type                                                                                                                                                          |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__namedParameters` | [`UseCloseDistributorOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/UseCloseDistributorOptions.md) |

### Returns

`UseMutationResult`<{`signature`: `string`;\
}, `Error`, [`CloseDistributorParams`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/CloseDistributorParams.md), `unknown`>

...
| Parameter           | Type                                                                                                                                                      |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__namedParameters` | [`UseAddDistributorOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/UseAddDistributorOptions.md) |

### Returns

`UseMutationResult`<`DistributorResponse`, `Error`, [`AddDistributorParams`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/platform/react/interfaces/AddDistributorParams.md), `unknown`>

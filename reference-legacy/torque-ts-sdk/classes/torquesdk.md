...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------ |
| `options` | [`TorqueSDKOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/TorqueSDKOptions.md) | The options for the TorqueSDK. |
...
| `signTransaction`? | [`SignTransaction`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/SignTransaction.md) | The function used to sign transactions. If provided, it will override the default signing method. |
| `ApiInputLogin`?   | [`ApiInputLogin`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiInputLogin.md)     | The login options for the user.                                                                   |
...
| Parameter | Type                                                                                                                                 | Description                                     |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| `params`  | [`ApiInputLogin`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiInputLogin.md) | The parameters for constructing the login body. |
...
`Promise`<[`ApiIdentifyPayload`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiIdentifyPayload.md)>

...
| Parameter | Type                                                                                                                                               |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `options` | [`TorqueRequestOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/TorqueRequestOptions.md) |
...
| `signTransaction` | `undefined` \| [`SignTransaction`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/SignTransaction.md) |
...
`Promise`<[`TxnExecuteResponse`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/TxnExecuteResponse.md)>
...
`Promise`<[`WithSignature`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/WithSignature.md)<`T`>>

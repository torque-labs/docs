...
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| `options` | [`TorqueAudienceClientOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/TorqueAudienceClientOptions.md) | The options for the TorqueAudienceClient. |
...
| Parameter | Type                                                                                                                                 | Description                         |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| `options` | [`AudienceBuild`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/AudienceBuild.md) | The options for the audience build. |

**Returns**

`Promise`<[`AudienceBuildResponse`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/AudienceBuildResponse.md)>
...
| Parameter    | Type                                                                                                                       | Description                                |
| ------------ | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `audience`   | [`Audience`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/Audience.md) | The options for the audience verification. |
| `publicKey`? | `string`                                                                                                                   | -                                          |

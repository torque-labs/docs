...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `options` | [`TorqueUserClientOptions`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/TorqueUserClientOptions.md) | The options for the TorqueUserClient. |
...
| `user`                   | `undefined` \| [`ApiUser`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiUser.md) |
...
`Promise`<[`ApiUserJourney`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiUserJourney.md)>
...
`Promise`<[`ApiTelegramAuth`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiTelegramAuth.md)>
...
`Promise`<`undefined` | [`ApiCampaignJourney`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiCampaignJourney.md)>
...
`Promise`<`undefined` | [`ApiUser`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiUser.md)>
...
`Promise`<{ `campaigns`: [`ApiCampaign`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiCampaign.md)\[]; }>

A Promise resolving to an array of `ApiCampaign` objects representing the active campaigns.

| Name        | Type                                                                                                                                |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `campaigns` | [`ApiCampaign`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiCampaign.md)\[] |
...
`Promise`<[`ApiShare`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiShare.md)>
...
`Promise`<[`ApiUserPayout`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiUserPayout.md)>
...
| Parameter   | Type                                                                                                                                 | Description                                                                |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| `userAuth`? | [`ApiInputLogin`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiInputLogin.md) | User signature object that is required to authenticate a user with Torque. |

**Returns**

`Promise`<[`ApiUser`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiUser.md)>
...
| Parameter      | Type                                                                                                                                 | Description                                                                  |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| `loginOptions` | [`ApiInputLogin`](https://github.com/torque-labs/torque-public/blob/main/docs/reference/torque-ts-sdk/type-aliases/ApiInputLogin.md) | The verification object that is required to authenticate a user with Torque. |
